...
class usuario:
    ...
    #def deposito(self, numcuenta,monto,fecha):

    # def retiro(self, numcuenta,monto,fecha):

    # def transferencia(self,usuario,numcuenta, monto,fecha):

    #def listarmovimientos(self, numcuenta):



#metodo del objeto usuario que permite depositar en una cuenta
def depositarcuentas(objetousuario):
  if len(objetousuario.cuentas) > 0:
    ...
    cond = False
    while cond == False:
      print("Seleccione la cuenta (No.) a la que le desea depositar : ",end='')
      Ncuenta = input()
      ...
      if cond == False:
        ...
        while cond2 == False:
          ...
          respuesta = input()
          cond2 = respuesta in ["S","s"]
          if cond2:
            # print(objetousuario.cuentas[int(Ncuenta.strip())-1]['saldo'])
...
def retirarcuentas(objetousuario):
  if len(objetousuario.cuentas) > 0:
    ...
    cond = False
    while cond == False:
      print("Seleccione la cuenta (No.) de la que desea hacer el retiro : ",end='')
      Ncuenta = input()
      cond = Ncuenta in (listaindices)
      if cond == False:
...
#tipo_validacion = numero, fecha, rango
...
def seleccionarusuario(listausuarios):
  ...
  if len(listausuarios) > 0:
    ...
    # while cond:
    #   validar_lectura()
    #   print("\n\n Seleccione el usuario con el que desea trabajar de acuerdo a No. : ")
    #   input()
...
input()
    ...
    #for i in range(0,10):
    #       print('\r H M S 0 0 {}'.format(cadena + str(i)), end='')
          #time.sleep(1)


    # {'num_cuenta':'cor-12345', 'tipo':'corriente','monto$':500,'fecha_apertura':'20191010'}
